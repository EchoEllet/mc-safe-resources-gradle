    ...
    private fun generateOutputClassFile(
        ...
        val fileText = when (outputLanguage) {
            OutputLanguage.JAVA -> """
                ...
                |///
                |/// This file is fully generated by Gradle scripts. DO NOT MODIFY DIRECTLY, as all changes will be overwritten.
                |/// Update the task `${taskName}` in `build.gradle.kts` OR `build.gradle` if needed.
                |@ApiStatus.Internal
